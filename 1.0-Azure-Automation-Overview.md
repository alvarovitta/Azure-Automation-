...
Deploy a VM on Azure/on-  


premises cloud and enable  
...
Deploy anew service to Azure and  
...
Cookbook/recipe/run list 
 


Module/class/manifest 
 


Node configuration/DSC resources 
